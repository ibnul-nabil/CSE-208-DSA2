...
public:
    ...
    bool Find(const string k , unsigned long long (*hash_function)(string) , int &probe){
    ...
    void print(){
        ...
        for(int i = 0 ; i<table.size() ; i++ ){
            if (table[i].key!= "0") cout   <<  i  << " : "<< table[i].key  << " " << table[i].value << endl;
            else cout  <<  i << " : null\n" ;
        }
    }
...
public:
    ...
    bool Find(string k , unsigned long long (*hash_function)(string) , int &probe){
        unsigned hash_val = hash_function(k) % size;
        unsigned indx = hash_val % size ;
        int i = 0;
...
int main (){
    ...
    while (t--){
        ...
        // cout  << prb << endl;
        // }
        // cout << (1.0*total)/1000 << " successful " << successful << endl;
